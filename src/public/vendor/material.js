   ...
   */
     ...
     */
      const downgradeNode = function (node) {
        createdComponents_.filter((item) => {
...
/**
  ...
  MaterialMenu.prototype.handleForKeyboardEvent_ = function (evt) {
    if (this.element_ && this.container_ && this.forElement_) {
      const items = this.element_.querySelectorAll(`.${this.CssClasses_.ITEM}:not([disabled])`);
...
/**
  ...
  MaterialMenu.prototype.show = function (evt) {
    if (this.element_ && this.container_ && this.outline_) {
      ...
      const transitionDuration = this.Constant_.TRANSITION_DURATION_SECONDS * this.Constant_.TRANSITION_DURATION_FRACTION;
...
/**
  ...
  MaterialSlider.prototype.updateValueStyles_ = function () {
    ...
    const fraction = (this.element_.value - this.element_.min) / (this.element_.max - this.element_.min);
    if (fraction === 0) {
...
/**
  ...
  MaterialLayout.prototype.contentScrollHandler_ = function () {
    ...
    const headerVisible = !this.element_.classList.contains(this.CssClasses_.IS_SMALL_SCREEN) || this.element_.classList.contains(this.CssClasses_.FIXED_HEADER);
...
/**
  ...
  MaterialLayout.prototype.init = function () {
    if (this.element_) {
      ...
      if (this.drawer_) {
        let drawerButton = this.element_.querySelector(`.${this.CssClasses_.DRAWER_BTN}`);
        if (!drawerButton) {
